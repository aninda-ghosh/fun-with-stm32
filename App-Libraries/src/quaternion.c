...
static void updateIMU(float gx, float gy, float gz, float ax, float ay, float az);
...
void madwickGetAngles(float *angles){
	...
	angles[0] = roll * 57.29578f;
	angles[1] = pitch * 57.29578f;
	angles[2] = yaw * 57.29578f + 180.0f;
}
